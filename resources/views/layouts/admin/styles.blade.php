<link rel="stylesheet" href="{!! \URLHelper::asset('libs/bootstrap/css/bootstrap.min.css', 'admin') !!}">
...
<link rel="stylesheet" href="{!! \URLHelper::asset('libs/bootstrap-datepicker/css/bootstrap-datepicker.min.css', 'admin') !!}">
